...
<meta property="og:image" content="http://trewgear.com/resources/images/nav/trewLogoBurst.png"/>
...
<meta name="copyright" content="©2012 TREW Gear LLC, All rights reserved.">
...
<script language="javascript" type="text/javascript" src="http://localhost:8888/resources/js/menu.js"></script>
<script language="javascript" type="text/javascript" src="http://localhost:8888/resources/js/subscribe.js"></script>
<div id="trew_nav_main">
	<a id="trew_nav_logo" href="http://localhost:8888/"></a>
	<div id="trew_nav_wrap">
	<ul id="trew_nav">
	    <li class="topButton"><a href="http://localhost:8888/productwall.php?cID=outerwear">PRODUCT</a>
			<ul class="tier1">
				<li class="subButton top"><a href="http://localhost:8888/productwall.php?cID=Jackets">JACKETS</a>
					<ul class="tier2">
						<li class="subButton"><a href="http://localhost:8888/pdp.php?pID=cosmic">THE COSMIC</a><ul class="product_cta" id="cosmic"></ul></li>
						<li class="subButton"><a href="http://localhost:8888/pdp.php?pID=powfunk">THE POW-FUNK</a><ul class="product_cta" id="powfunk"></ul></li>
						<li class="subButton"><a href="http://localhost:8888/pdp.php?pID=bellows">THE BELLOWS</a><ul class="product_cta" id="bellows"></ul></li>
						<li class="subButton"><a href="http://localhost:8888/pdp.php?pID=wyeast">WYEAST</a><ul class="product_cta" id="wyeast"></ul></li>
					</ul>
				</li>
				<li class="subButton"><a href="http://localhost:8888/productwall.php?cID=Pants">PANTS</a>
					<ul class="tier2">
						<li class="subButton"><a href="http://localhost:8888/pdp.php?pID=eaglepant">THE EAGLE PANT</a><ul class="product_cta" id="eaglepant"></ul></li>
						<li class="subButton"><a href="http://localhost:8888/pdp.php?pID=trewthbib">THE TREWTH BIB</a><ul class="product_cta" id="trewthbib"></ul></li>
					</ul>
				</li>
				<li class="subButton"><a href="http://localhost:8888/productwall.php?cID=Apparel">ACCESSORIES</a></li>
				<li class="subButton"><a href="http://localhost:8888/warranty.php">WARRANTY</a></li>
			</ul>
		</li>
	    <li class="topButton"><a href="http://localhost:8888/mission.php">ABOUT US</a>
			<ul class="tier1">
				<li class="subButton"><a href="http://localhost:8888/mission.php">MISSION</a></li>
				<li class="subButton"><a href="http://localhost:8888/philosophy.php">PHILOSOPHY</a></li>
				<li class="subButton"><a href="http://localhost:8888/trewth.php">TREWTH</a></li>
				<li class="subButton"><a href="http://localhost:8888/team.php">TEAM</a></li>
			</ul>
		</li>
		<li class="topButton"><a href="http://localhost:8888/blog">BLOG</a></li>
		<li class="topButton last"><a href="http://localhost:8888/dealers.php">DEALERS</a></li>
	...
	<div class="trew_nav_social">
		...
		<a href="http://flickr.com" class="social flickr"></a>
	</div>
	...
	<div style="background:#fff; min-height:600px;">
		<div class="content" style="padding-top:100px;">
	        ...
	        <script src="//api.emeraldcode.com/js/plugins/jquery.dumbfix.1.0.js"></script>
	        <script src="//api.emeraldcode.com/js/plugins/jquery.dumbformstate.js"></script>
	        <script src="//api.emeraldcode.com/js/plugins/jquery.dumbvalidation.js"></script>
	        <script src="//api.emeraldcode.com/js/validation-methods.js"></script>
	...
	<div id="footerContent">
		...
		<div id="footer_address">
			...
			*call 541-241-MTNS for our office location<br>
			...
			<div class="clear"></div>
			<div class="socialIcon"><a href="http://www.onepercentfortheplanet.org"><img src="http://localhost:8888/resources/images/footer/onepercent.gif" border=0></a></div>
		</div>
		<div id="footer_nav">
			<b><a href="http://localhost:8888/productwall.php?cID=outerwear">PRODUCTS</a></b><br>
			<a href="http://localhost:8888/productwall.php?cID=jacket">Jackets</a> / <a href="http://localhost:8888/productwall.php?cID=pant">Pants</a> / <a href="http://localhost:8888/productwall.php?cID=Apparel">Swag</a><br>
			<a href="http://www.shopatron.com/products/category/1771.0.1.1.80549.0.0.0.0">Jackets / Pants / Swag / 2010 Collection</a><br>
			<b><a href="http://localhost:8888/mission.php">ABOUT US</a></b><br>
			<b><a href="http://localhost:8888/blog">TOUR</a></b><br>
			<b><a href="mailto:info@trewgear.com">CONTACT</a></b><br>
		</div>
	</div>
	<div id="footerBase">
		<div class="content">
			<p>©2012 Copyright, Trew Gear LLC.</p>
		</div>
	</div>
</div>
