...
if ( !empty( $image ) ) {
	if ( $link ) {
		echo '<a class="'.$this->widget_options['classname'].'-image-link" href="'.esc_url($link).'" target="'.esc_attr($linktarget).'" style="background:url('.esc_url($imageurl).');">';
	}
	
	echo '<div class="tout-text">';
